...
module "security_group" {
  ...
  computed_ingress_with_source_security_group_id = [
    {
      rule                     = "postsges-tcp"
      source_security_group_id = data.tfe_outputs.backend_asg.backend_security_group_id
    }
  ]
...
module "rds" {
  ...
  subnet_ids             = data.tfe_outputs.vpc.database_subnets
  ...
  db_subnet_group_name                  = data.tfe_outputs.vpc.database_subnet_group
